...
parser.add_argument('--checkpoint_dir', type=str, default='/gdata1/dongch/end2end_videocompress_alldata/end2end/three_level_update_rate_bitplane/base_6/')
parser.add_argument('--log_dir', type=str, default='/ghome/dongch/end2end_videocompress_alldata/end2end/three_level_update_rate_bitplane/base_6/')
parser.add_argument('--epochs', type=int, default=1000)
parser.add_argument('--batch_size', type=int, default=3)
parser.add_argument('--load_model', type=str,default="/gdata1/dongch/end2end_videocompress_alldata/end2end/three_level_update_rate_bitplane/base_8/epoch330.pth")
# parser.add_argument('--load_model', type=str,default=None)
# parser.add_argument('--rate_b', type=str,default="/gdata1/dongch/end2end_videocompress_alldata/end2end/three_level_update_rate/base_6/epoch180.pth")
