...
parser.add_argument('--input_train_dir', type=str, default=r'/gdata1/dongch/john_mv/three_level_update/name_list.txt')
parser.add_argument('--input_test_dir', type=str, default=r'/gdata1/dongch/john_mv/three_level_update/test/test/')
# parser.add_argument('--input_test_dir', type=str, default=r'/gdata1/dongch/john_mv/traintry')
parser.add_argument('--checkpoint_dir', type=str, default='/gdata1/dongch/end2end_videocompress_alldata/end2end/three_level_update_rate_bitplane_post/base_5/')
parser.add_argument('--log_dir', type=str, default='/ghome/dongch/end2end_videocompress_alldata/end2end/three_level_update_rate_bitplane_post/base_5/')
parser.add_argument('--epochs', type=int, default=1000)
parser.add_argument('--batch_size', type=int, default=4)
# parser.add_argument('--load_model', type=str,default="/gdata1/dongch/end2end_videocompress_alldata/end2end/three_level_update_rate_bitplane_post/base/epoch000.pth")
parser.add_argument('--load_model', type=str,default=None)
# parser.add_argument('--rate_b', type=str,default="/gdata1/dongch/end2end_videocompress_alldata/end2end/three_level_update_rate/base_5/epoch180.pth")
...
def main():
    ...
    alpha_list = [10, 10, 10, 10, 2]  # 在本次实验中，alpha没用，因为使用的是round
    crop_size = 256
    train_step = 4  # 大分辨率需要设置的更大，这样得到的LL子带才会比较小
    ...
    test_loader = DataLoader(dataset=dataset_test, batch_size=1, shuffle=True, num_workers=8, pin_memory=True)
    ...
    while( epoch < total_epoch):
        ...
        for batch_idx, input_img in enumerate(train_loader):
            ...
            loss = (- lambda_d * psnr_ave)/accumulation_steps
