...
from image_enhance_multi import PostProcessing as PostProcessing_multi
from image_enhance_multi_simple import PostProcessing as PostProcessing_multi_simple
import numpy as np
...
class Model_all(torch.nn.Module):
    ...
    def forward(self, frame, mask, mv, grid_up, grid_org, train, alpha_list):
        ...
        L3 = self.image_enhance_H3_update(L3, -L_tmp/alpha_level, L3_rec_list[0]/beta_level)
        ...
        L2 = self.image_enhance_H2_update(L2, -L_tmp/alpha_level, L3_rec_update_list[i]/beta_level)
        ...
        L1 = self.image_enhance_H1_update(L1, -L_tmp/alpha_level, L2_rec_update_list[i]/beta_level)
